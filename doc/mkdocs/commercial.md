...
To learn about URL structure read [REST API Basics](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/api_basics.md#basic-uri-structure).
...
* Read [REST API Basics](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/api_basics.md) to know more about Crossbar REST API.
* How to [Authenticate your REST requests](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/how_to_authenticate.md).
