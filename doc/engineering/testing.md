# Unit- and Property-based testing in {% BRAND_NAME %}

## Unit Testing

{% BRAND_NAME %} uses EUnit for the majority of unit testing. Running `make eunit` from the root or within an Erlang application directory will run the tests of the project or app respectively. Modules will be cover-compiled as well, generating a cover report that can be viewed in a browser.
...
{% BRAND_NAME %} uses PropEr for doing property-based testing.
