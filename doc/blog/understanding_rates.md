...
1.  Admins can create ratedecks by uploading CSVs to the [Tasks API](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/tasks.md) and defining the \`ratedeck\_id\`. See the [Rate Task](https://docs.2600hz.com/git/2600hz/kazoo-tasks/doc/rates.md) docs for how to upload the CSV. This will be covered further down too.
...
The rest of this article will demonstrate the API commands necessary to configure the ratedecks, service plans, and accounts to have this all work appropriately. Hopefully someone will be inspired to create an appropriate [Monster UI](https://docs.2600hz.com/git/2600hz/monster-ui/docs/mkdocs/getting-started.md) application to manage this from the browser!
...
Also, be sure you've handled the [Tasks Operations](https://docs.2600hz.com/git/2600hz/kazoo-crossbar/doc/tasks.md) steps to start the tasks application and the tasks crossbar endpoint.
...
Looking at the [Rates Task](https://docs.2600hz.com/git/2600hz/kazoo-tasks/doc/rates.md) we see the following fields that can be defined:
...
Take a look at the [Service Plan lifecycle](https://docs.2600hz.com/git/2600hz/kazoo-core/kazoo_services/doc/lifecycle.md) for details on how service plans work. Basically, we have a category of `ratedeck` and an item with the `ratedeck_id` as the key. You can also optionally include surcharges, activation fees, etc.
