...
docs_index: pr_template
	@ERL_LIBS="$(ELIBS)" $(ROOT)/scripts/build-application-doc-index.escript $(ROOT) $(CURDIR)
...
hank:
	@ERL_LIBS=$(ELIBS) $(ROOT)/scripts/hank.escript $(wildcard src/*.[h|e]rl) $(wildcard src/*/*.[h|e]rl) $(wildcard include/*.hrl)
